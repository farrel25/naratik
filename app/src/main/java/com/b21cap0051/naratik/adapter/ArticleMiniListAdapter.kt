...
class ArticleMiniListAdapter(private val callback: ItemArticleCallBack) :
	...
	inner class ItemTarget(private val binding: ItemRowArticleMiniBinding) : RecyclerView.ViewHolder(binding.root) {
	...
	override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemTarget {
		val binding = ItemRowArticleMiniBinding.inflate(LayoutInflater.from(parent.context), parent, false)
