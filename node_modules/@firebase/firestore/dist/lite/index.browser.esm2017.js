 ...
 */ function p(t = "Unexpected state") {
    ...
    const n = "FIRESTORE (8.4.2) INTERNAL ASSERTION FAILED: " + t;
...
class zn extends class {} {
    ...
    /** Gets an auth token and invokes the provided RPC. */    g(t, n, e) {
        return this.tt(), this.credentials.getToken().then((r => this.Z.g(t, n, e, r))).catch((t => {
            throw "FirebaseError" === t.name ? (t.code === R && this.credentials.invalidateToken(), 
            t) : new O(b, t.toString());
        }));
    }
...
}), "PUBLIC" /* PUBLIC */)), s("firestore-lite", "2.2.5", "node");
