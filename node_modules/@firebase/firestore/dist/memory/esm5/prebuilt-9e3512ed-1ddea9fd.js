 ...
 */ function N(t) {
    ...
    if (I.logLevel <= a.DEBUG) {
        var r = e.map(k);
        I.debug.apply(I, b([ "Firestore (8.4.2): " + t ], r));
    }
}
...
function S(t) {
    ...
    if (I.logLevel <= a.ERROR) {
        var r = e.map(k);
        I.error.apply(I, b([ "Firestore (8.4.2): " + t ], r));
    }
}
...
function D(t) {
    ...
    if (I.logLevel <= a.WARN) {
        var r = e.map(k);
        I.warn.apply(I, b([ "Firestore (8.4.2): " + t ], r));
    }
}
 ...
 */ function Wo(t, e) {
    ...
    if (!(t instanceof Go || t instanceof Qo)) throw new T(E.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    return Vo(n = t._path.child(G.fromString.apply(G, b([ e ], r)))), new Go(t.firestore, t instanceof Qo ? t._converter : null, new rt(n));
}
 ...
 */ var Vs = /** @class */ function() {
    ...
    t.prototype.forEach = function(t, e) {
        ...
        this._snapshot.docs.forEach((function(r) {
            t.call(e, new Us(n._firestore, n._userDataWriter, r.key, r, new Vs(n._snapshot.mutatedKeys.has(r.key), n._snapshot.fromCache), n.query._converter));
        }));
    }, 
    /**
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((function(e) {
                    var r = new Us(t._firestore, t._userDataWriter, e.doc.key, e.doc, new Vs(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query._converter);
                    return e.doc, {
                        type: "added",
                        doc: r,
                        oldIndex: -1,
            ...
            return t._snapshot.docChanges.filter((function(t) {
                ...
                var n = new Us(t._firestore, t._userDataWriter, e.doc.key, e.doc, new Vs(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query._converter), i = -1, o = -1;
 ...
 */ function cu(t, e, n) {
    ...
    return new Ms(t, i, e._key, r, new Vs(n.hasPendingWrites, n.fromCache), e._converter);
}
...
//# sourceMappingURL=prebuilt-9e3512ed-1ddea9fd.js.map
