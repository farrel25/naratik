...
import { useFirestoreEmulator as o, enableNetwork as i, disableNetwork as a, waitForPendingWrites as u, onSnapshotsInSync as s, collection as c, doc as f, collectionGroup as l, runTransaction as h, ensureFirestoreConfigured as p, WriteBatch as d, executeWrite as g, Bytes as y, AbstractUserDataWriter as m, DocumentSnapshot as _, QueryDocumentSnapshot as v, DocumentReference as w, refEqual as b, setDoc as P, updateDoc as S, deleteDoc as I, onSnapshot as D, getDocFromCache as E, getDocFromServer as O, getDoc as j, snapshotEqual as F, query as x, where as A, orderBy as C, limit as T, limitToLast as B, startAt as N, startAfter as R, endBefore as q, endAt as Q, queryEqual as W, getDocsFromCache as L, getDocsFromServer as U, getDocs as k, QuerySnapshot as V, addDoc as z, FieldPath as K, serverTimestamp as M, deleteField as G, arrayUnion as Z, arrayRemove as $, increment as J, loadBundle as H, namedQuery as Y, GeoPoint as X, Timestamp as ee, CACHE_SIZE_UNLIMITED as te, enableIndexedDbPersistence as re, enableMultiTabIndexedDbPersistence as ne, clearIndexedDbPersistence as oe } from "@firebase/firestore";
 ...
 * limitations under the License.
 */
var ce = new ie("@firebase/firestore");
 ...
 */ function le(e) {
    ...
    // exception is swallowed.
        var r = "FIRESTORE (8.4.2) INTERNAL ASSERTION FAILED: " + e;
    // NOTE: We don't use FirestoreError here because these are internal failures
    // that cannot be handled by the user. (Also it would create a circular
    // dependency between the error and assert modules which doesn't work.)
    throw function(e) {
        for (var r = [], n = 1; n < arguments.length; n++) r[n - 1] = arguments[n];
        if (ce.logLevel <= ae.ERROR) {
            var o = r.map(fe);
            ce.error.apply(ce, t([ "Firestore (8.4.2): " + e ], o));
        }
    }(r), new Error(r);
}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ var he = "invalid-argument", pe = "failed-precondition", de = "unimplemented", ge = /** @class */ function(t) {
    /** @hideconstructor */
    function r(
    /**
    ...
    return e(r, t), r;
}(Error), ye = /** @class */ function() {
    function e(e, t, r) {
        void 0 === t ? t = 0 : t > e.length && le(), void 0 === r ? r = e.length - t : r > e.length - t && le(), 
    ...
    r.fromString = function() {
        ...
        // for legacy reasons and should not be used frequently).
            ...
            var a = i[o];
            if (a.indexOf("//") >= 0) throw new ge(he, "Invalid segment (" + a + "). Paths must not contain // in them.");
...
}(ye), _e = /^[_a-zA-Z][_a-zA-Z0-9]*$/, ve = /** @class */ function(t) {
    function r() {
        return null !== t && t.apply(this, arguments) || this;
    }
    return e(r, t), r.prototype.construct = function(e, t, n) {
    ...
    r.fromServerFormat = function(e) {
        for (var t = [], n = "", o = 0, i = function() {
            if (0 === n.length) throw new ge(he, "Invalid field path (" + e + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            t.push(n), n = "";
        }, a = !1; o < e.length; ) {
            var u = e[o];
            if ("\\" === u) {
                if (o + 1 === e.length) throw new ge(he, "Path has trailing escape character: " + e);
                var s = e[o + 1];
                if ("\\" !== s && "." !== s && "`" !== s) throw new ge(he, "Path has invalid escape sequence: " + e);
                n += s, o += 2;
            } else "`" === u ? (a = !a, o++) : "." !== u || a ? (n += u, o++) : (i(), o++);
        }
        if (i(), a) throw new ge(he, "Unterminated ` in path: " + e);
        return new r(t);
    }, r.emptyPath = function() {
        return new r([]);
    }, r;
}(ye), we = /** @class */ function() {
    function e(e) {
        this.path = e;
    }
    return e.fromPath = function(t) {
        return new e(me.fromString(t));
    }, e.fromName = function(t) {
        return new e(me.fromString(t).popFirst(5));
    }, 
    /** Returns true if the document is in the specified collectionId. */
    e.prototype.hasCollectionId = function(e) {
        return this.path.length >= 2 && this.path.get(this.path.length - 2) === e;
    }, e.prototype.isEqual = function(e) {
        return null !== e && 0 === me.comparator(this.path, e.path);
    }, e.prototype.toString = function() {
        return this.path.toString();
    }, e.comparator = function(e, t) {
        return me.comparator(e.path, t.path);
...
function be(e, t) {
    ...
    if (void 0 !== t.mergeFields && void 0 !== t.merge) throw new ge(he, "Invalid options passed to function " + e + '(): You cannot specify both "merge" and "mergeFields".');
    return t;
}
...
t) {
    ...
    e = e._delegate), !(e instanceof t)) {
        if (t.name === e.constructor.name) throw new ge(he, "Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");
        var r = 
        ...
        function(e) {
            ...
            return "function" == typeof e ? "a function" : le();
        }(e);
        throw new ge(he, "Expected type '" + t.name + "', but it was: " + r);
    }
    return e;
}
...
function Se() {
    if ("undefined" == typeof Uint8Array) throw new ge(de, "Uint8Arrays are not available in this environment.");
}

/** Helper function to assert Base64 functions are available at runtime. */ function Ie() {
    if ("undefined" == typeof atob) throw new ge(de, "Blobs are unavailable in Firestore in this environment.");
}

/** Immutable class holding a blob (binary data) */ var De = /** @class */ function() {
    function e(e) {
        this._delegate = e;
    }
    return e.fromBase64String = function(t) {
        return Ie(), new e(y.fromBase64String(t));
    }, e.fromUint8Array = function(t) {
        return Se(), new e(y.fromUint8Array(t));
    }, e.prototype.toBase64 = function() {
        return Ie(), this._delegate.toBase64();
    }, e.prototype.toUint8Array = function() {
        return Se(), this._delegate.toUint8Array();
    }, e.prototype.isEqual = function(e) {
...
var Oe = /** @class */ function() {
    ...
    return Object.defineProperty(e.prototype, "_databaseId", {
    ...
    }, e.prototype.useEmulator = function(e, t) {
        o(this._delegate, e, t);
        ...
        return e && function(e, t, r, n) {
            if (!0 === t && !0 === n) throw new ge(he, e + " and " + r + " cannot be used together.");
        ...
        get: function() {
            if (!this._appCompat) throw new ge(pe, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
        ...
        try {
            return new ke(this, c(this._delegate, e));
        } catch (e) {
        ...
        try {
            return new We(this, l(this._delegate, e));
        } catch (e) {
        ...
        var e = this;
        return p(this._delegate), new Ae(new d(this._delegate, (function(t) {
            return g(e._delegate, t);
        })));
    }, e.prototype.loadBundle = function(e) {
        throw new ge(pe, '"loadBundle()" does not exist, have you imported "firebase/firestore/bundle"?');
    }, e.prototype.namedQuery = function(e) {
        throw new ge(pe, '"namedQuery()" does not exist, have you imported "firebase/firestore/bundle"?');
    }, e;
}(), Fe = /** @class */ function(t) {
    function r(e) {
...
var xe = /** @class */ function() {
    function e(e, t) {
        this._firestore = e, this._delegate = t, this._userDataWriter = new Fe(e);
    }
    return e.prototype.get = function(e) {
        var t = this, r = Ve(e);
        return this._delegate.get(r).then((function(e) {
            return new qe(t._firestore, new _(t._firestore._delegate, t._userDataWriter, e._key, e._document, e.metadata, r._converter));
        }));
    }, e.prototype.set = function(e, t, r) {
        var n = Ve(e);
        return r ? (be("Transaction.set", r), this._delegate.set(n, t, r)) : this._delegate.set(n, t), 
        this;
    ...
    return e.prototype.set = function(e, t, r) {
        var n = Ve(e);
        return r ? (be("WriteBatch.set", r), this._delegate.set(n, t, r)) : this._delegate.set(n, t), 
        this;
    }, e.prototype.update = function(e, r, n) {
        for (var o, i = [], a = 3; a < arguments.length; a++) i[a - 3] = arguments[a];
        var u = Ve(e);
    ...
    return e.prototype.fromFirestore = function(e, t) {
        ...
        /* converter= */ null);
        return this._delegate.fromFirestore(new Qe(this._firestore, r), null != t ? t : {});
    ...
    e.getInstance = function(t, r) {
        ...
        var i = o.get(r);
        return i || (i = new e(t, new Fe(t), r), o.set(r, i)), i;
    }, e;
}();

Ce.INSTANCES = new WeakMap;
...
var Te = /** @class */ function() {
    function e(e, t) {
        this.firestore = e, this._delegate = t, this._userDataWriter = new Fe(e);
    }
    return e.forPath = function(t, r, n) {
        if (t.length % 2 != 0) throw new ge(he, "Invalid document reference. Document references must have an even number of segments, but " + t.canonicalString() + " has " + t.length);
        return new e(r, new w(r._delegate, n, new we(t)));
        ...
        get: function() {
            return new ke(this.firestore, this._delegate.parent);
        },
        enumerable: !1,
        configurable: !0
        ...
        try {
            return new ke(this.firestore, c(this._delegate, e));
        } catch (e) {
        ...
        var n = Ne(t), o = Re(t, (function(t) {
            return new qe(e.firestore, new _(e.firestore._delegate, e._userDataWriter, t._key, t._document, t.metadata, e._delegate._converter));
        }));
        ...
        return ("cache" === (null == e ? void 0 : e.source) ? E(this._delegate) : "server" === (null == e ? void 0 : e.source) ? O(this._delegate) : j(this._delegate)).then((function(e) {
            return new qe(t.firestore, new _(t.firestore._delegate, t._userDataWriter, e._key, e._document, e.metadata, t._delegate._converter));
        }));
    }, e.prototype.withConverter = function(t) {
        return new e(this.firestore, t ? this._delegate.withConverter(Ce.getInstance(this.firestore, t)) : this._delegate.withConverter(null));
    }, e;
}();
 ...
 */ function Ne(e) {
    for (var t = 0, r = e; t < r.length; t++) {
        var n = r[t];
        if ("object" == typeof n && !Ee(n)) return n;
    }
    return {};
}
 ...
 */ function Re(e, t) {
    ...
    return {
        ...
        error: null === (r = (o = Ee(e[0]) ? e[0] : Ee(e[1]) ? e[1] : "function" == typeof e[0] ? {
            next: e[0],
            error: e[1],
            complete: e[2]
        } : {
...
var qe = /** @class */ function() {
    ...
    return e.prototype.where = function(t, r, n) {
        ...
        return ("cache" === (null == e ? void 0 : e.source) ? L(this._delegate) : "server" === (null == e ? void 0 : e.source) ? U(this._delegate) : k(this._delegate)).then((function(e) {
            return new Ue(t.firestore, new V(t.firestore._delegate, t._userDataWriter, t._delegate, e._snapshot));
        }));
    }, e.prototype.onSnapshot = function() {
        for (var e = this, t = [], r = 0; r < arguments.length; r++) t[r] = arguments[r];
        var n = Ne(t), o = Re(t, (function(t) {
            return new Ue(e.firestore, new V(e.firestore._delegate, e._userDataWriter, e._delegate, t._snapshot));
        }));
        return D(this._delegate, n, o);
    }, e.prototype.withConverter = function(t) {
        return new e(this.firestore, t ? this._delegate.withConverter(Ce.getInstance(this.firestore, t)) : this._delegate.withConverter(null));
    ...
    return Object.defineProperty(e.prototype, "type", {
        ...
        get: function() {
            return new Qe(this._firestore, this._delegate.doc);
        },
        enumerable: !1,
        configurable: !0
    ...
    return Object.defineProperty(e.prototype, "query", {
        get: function() {
            return new We(this._firestore, this._delegate.query);
        },
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(e.prototype, "metadata", {
        ...
        return this._delegate.docChanges(e).map((function(e) {
            return new Le(t._firestore, e);
        }));
    }, e.prototype.forEach = function(e, t) {
        var r = this;
        this._delegate.forEach((function(n) {
            e.call(t, new Qe(r._firestore, n));
        }));
    }, e.prototype.isEqual = function(e) {
        return F(this._delegate, e._delegate);
    }, e;
    ...
    return e(r, t), Object.defineProperty(r.prototype, "id", {
        ...
        var t = this;
        return z(this._delegate, e).then((function(e) {
        ...
        return new r(this.firestore, e ? this._delegate.withConverter(Ce.getInstance(this.firestore, e)) : this._delegate.withConverter(null));
    }, r;
}(We);
...
var Me = /** @class */ function() {
    ...
    function e() {
        ...
        this._delegate = new (K.bind.apply(K, t([ void 0 ], e)));
    }
    return e.documentId = function() {
         ...
         * effect is the same.
         */
        return new e(ve.keyField().canonicalString());
    }, e.prototype.isEqual = function(e) {
        return (e = n(e)) instanceof K && this._delegate._internalPath.isEqual(e._internalPath);
    }, e;
}(), Ge = /** @class */ function() {
    function e(e) {
        this._delegate = e;
    ...
    DocumentSnapshot: qe,
    Query: We,
    QueryDocumentSnapshot: Qe,
    QuerySnapshot: Ue,
    CollectionReference: ke,
    FieldPath: Me,
    FieldValue: Ge,
    setLogLevel: function(e) {
        var t;
        t = e, ce.setLogLevel(t);
    },
 ...
 */
    function(e, t) {
        e.INTERNAL.registerComponent(new ue("firestore-compat", (function(e) {
            ...
            return t(r, n);
        }), "PUBLIC" /* PUBLIC */).setServiceProps(Object.assign({}, Ze)));
    }(e, (function(e, t) {
        return new je(e, t, new Oe);
    })), e.registerVersion("@firebase/firestore-compat", "0.0.900");
}

Je(r), ($e = je).prototype.loadBundle = ze, $e.prototype.namedQuery = Ke;

export { Je as registerFirestore };
