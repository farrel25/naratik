...
import { DocumentReference, CollectionReference, DocumentData, Query, PersistenceSettings, DocumentSnapshot, QuerySnapshot, FirebaseFirestore, Settings, LoadBundleTask, FirestoreError, Unsubscribe, SnapshotListenOptions, QueryConstraint, Transaction, SetOptions, UpdateData, FieldPath, WriteBatch } from "@firebase/firestore";
declare module "@firebase/firestore" {
    ...
    function useFirestoreEmulator(firestore: types.FirebaseFirestore, host: string, port: number): void;
