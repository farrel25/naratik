...
exports.JwtErrorCode = exports.JwtError = exports.decodeJwt = exports.verifyJwtSignature = exports.EmulatorSignatureVerifier = exports.PublicKeySignatureVerifier = exports.UrlKeyFetcher = exports.ALGORITHM_RS256 = void 0;
        ...
        jwt.verify(token, secretOrPublicKey, options, function (error) {
            ...
            if (error.name === 'TokenExpiredError') {
                ...
                if (error.message && error.message.includes(JWT_CALLBACK_ERROR_PREFIX)) {
                    ...
                    var code = (message === NO_MATCHING_KID_ERROR_MESSAGE) ? JwtErrorCode.NO_MATCHING_KID :
